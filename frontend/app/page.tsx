            ...
            <section className="relative pt-32 pb-20 px-4 overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto">
                    <div className="text-center max-w-4xl mx-auto mb-16">
                        {/* Badge */}
                        <div className="inline-flex items-center px-4 py-2 bg-blue-100 text-blue-700 rounded-full text-sm font-semibold mb-6 animate-pulse">
                            🚀 Η Πλατφόρμα #1 για Ραντεβού στην Ελλάδα
                        </div>
                        ...
                        <p className="text-xl md:text-2xl text-gray-600 mb-8 max-w-2xl mx-auto leading-relaxed">
                            Αυτοματοποίησε τις κρατήσεις, εξοικονόμησε χρόνο και αύξησε τα έσοδά σου. 
                            <strong className="text-gray-900"> Δωρεάν για πάντα.</strong>
                        </p>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                        {[
                            ...
                            { icon: "💳", title: "Δωρεάν για Πάντα", desc: "Χωρίς κρυφές χρεώσεις. Ποτέ." }
                        ].map((feature, i) => (
            ...
            <section className="relative py-24 px-4 overflow-hidden">
                ...
                <div className="max-w-4xl mx-auto text-center text-white">
                    ...
                    <p className="text-xl md:text-2xl mb-10 opacity-90 leading-relaxed">
                        Εγγραφή δωρεάν και ξεκίνα να δέχεσαι online ραντεβού σε λιγότερο από 2 λεπτά!
                    </p>
                    <div className="flex flex-col sm:flex-row justify-center gap-4">
                        <Link
                            href="/login"
                            className="group px-10 py-5 bg-white text-[#4a90e2] rounded-2xl font-bold text-lg hover:bg-gray-50 hover:shadow-2xl hover:scale-105 transition-all duration-200 flex items-center justify-center space-x-2"
                        >
                            <span>Ξεκίνα Τώρα Δωρεάν</span>
                            <svg className="w-5 h-5 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7l5 5m0 0l-5 5m5-5H6" />
                            </svg>
                        </Link>
                    ...
                    <p className="mt-6 text-sm opacity-75">
                        ✨ Χωρίς πιστωτική κάρτα • 🚀 Setup σε 2 λεπτά • ❤️ Δωρεάν για πάντα
                    </p>
                </div>
            </section>
